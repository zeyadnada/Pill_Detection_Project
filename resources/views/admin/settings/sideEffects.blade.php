        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add New Side Effects</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('sideEffectsSelection.store') }}" method="post">
                        @csrf
                        <div class="form-group">
                            <label for="recipient-name" class="col-form-label">Side Effect Name:</label>
    ...
    <div class="row px-5">
        <div class="col-12">
            <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                    @forelse ($sideEffects as $sideEffect)
                        <tr>
                            <td>{{ $sideEffect->id }}</td>
                            ...
                            <td>
                                 ...
                                 data-target="#deleteModal{{ $sideEffect->id }}">Delete</button>

                             <!-- Delete Confirmation Modal -->
                             <div class="modal fade" id="deleteModal{{ $sideEffect->id }}" tabindex="-1" role="dialog"
                                 ...
                                 <div class="modal-dialog modal-dialog-centered" role="document">
                                     <div class="modal-content">
                                         ...
                                         <div class="modal-footer">
                                             ...
                                             <form action="{{ route('sideEffectsSelection.destroy', $sideEffect->id) }}" method="post">
                                                 @method('DELETE')
                                                 @csrf
