...
@section('content')
    <div class="container">
        <div class="row">
            <div class="col-12">
                <form action="{{ route('pill.store') }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="form-row">
                        <div class="col-6">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-6">
                            ...
                            <select class="select2" name="contraindication[]" multiple="multiple"
                                data-placeholder="Select Contraindication" style="width: 100%;">
                    ...
                    <div class="form-row">
                        <div class="col-12">
                            ...
                            <input type="text" name="dosage" class="form-control"id="dosage" data-role="tagsinput"
                                multiple="multiple" />
                        </div>
                    </div>
                    <br>
                    <div class="form-row">
                        <div class="col-12">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror form-control custom-file" id="description"
                                name="description" placeholder="Enter Pill Description" rows="6">{{ old('description') }}</textarea>
                            @error('description')
                                <div class="error alert alert-danger">{{ $message }}</div>
                            @enderror
                        </div>
