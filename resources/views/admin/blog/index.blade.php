                    ...
                    <tbody>
                        @forelse ($articles as $article)
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('blog.show', $article->id) }}" class="btn btn-success">Details</a>
                                    <a href="{{ route('blog.edit', $article->id) }}" class="btn btn-warning">Edit</a>
                                    <button class="btn btn-danger" data-toggle="modal"
                                        data-target="#deleteModal{{ $article->id }}">Delete</button>
                                </td>
                            </tr>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="deleteModalLabel{{ $article->id }}">Confirm Delete
                                            </h5>
