    ...
    <nav class="navbar navbar-expand-lg bg-secondary shadow text-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="home.html">
                <img src="/images/log2.png" alt="Bootstrap" width="89" />
            </a>
            <a class="title" href="home.html">DPill</a>
                ...
                <ul class="navbar-nav me-auto mb-3 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a class="dropdown-item" href="browse-interaction.html">pill interaction</a>
                            </li>
