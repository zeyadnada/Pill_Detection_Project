...
@section('content')
    <div class="browse">
        ...
        <form action="{{ route('detection.make') }}" method="POST" enctype="multipart/form-data">
            @csrf
        <div class="header text-center mt-4">
            ...
            <input type="file" id="pillImageInput" style="display: none" name="img" />
        </div>
        <input type="submit" class="detectButton" value="Detect">
        </form>
